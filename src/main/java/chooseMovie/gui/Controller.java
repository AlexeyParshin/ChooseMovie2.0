...
public class Controller extends Application {
  ...
  public Controller() {
    ...
    for (int i = 1; i <= 10; i++) {
      allthreads.add(new ParsingThread(
          "https://www.kinopoisk.ru/s/type/film/list/1/order/rating/m_act%5Bgenre%5D%5B0%5D/6/m_act%5Bmpaa%5D/R/m_act%5Btype%5D/film/set_result_type/simple/page/"
              + i + "/"));
    }
